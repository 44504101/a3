// ----------------------------------------------------------------------------
/**
 * @file    	acqmtc_dsp_b/src/opcode217.h
 * @author		Benoit LeGuevel
 * @date		11 October 2013
 * @brief		Header file for opcode217.c
...
void opcode217_execute(ELoaderState_t* loaderState, LoaderMessage_t* message,
                       Timer_t* timer) ;
...
// ----------------------------------------------------------------------------
// ----------------------------------------------------------------------------
/*+- OmniWorks Replacement History - fe_dhs`dev28335`tool`crs`acqmtc_dsp_b`src:opcode217.h;3 */
